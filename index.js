...
let handleDraw = () => {
    ...
    if (!deckId) return header.textContent = "Please get new deck.";
    fetch(`https://apis.scrimba.com/deckofcards/api/deck/${deckId}/draw/?count=2`)
        ...
        .then(data => {
            ...
            if (data.remaining === 0) {
                ...
                if (computerScore > myScore) header.textContent = "The computer won the game!";
                else if (myScore > computerScore) header.textContent = "You won the game!";
